...
When you save the configuration, Audit Vision will **automatically create and maintain all required API Routes** in your DHIS2 instance (similar to how it handles SQL Views).
