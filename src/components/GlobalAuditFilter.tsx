  ...
  return (
    <>
      <button
        ...
        onClick={openModal}
        className={cn(
          'flex items-center gap-2 rounded-xl border border-[#dbe4f0] bg-white px-4 py-3 text-sm font-medium text-[#0f172a] shadow-[0_1px_2px_rgba(15,23,42,0.04)] transition hover:bg-[#f8fafc] cursor-pointer',
          className,
        )}
      >
        ...
        <span className="text-[#64748b]">{triggerPeriodLabel}</span>
      </button>
          ...
          >
            <div className="mb-8 flex items-start justify-between gap-4">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-[18px] font-bold text-[#1e293b]">Domain &amp; Period Filter</h2>
              </div>
              <button
                type="button"
                onClick={closeModal}
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <input
                      ...
                      className="h-[44px] w-full rounded-xl border border-[#e2e8f0] bg-white px-4 text-sm text-[#334155] outline-none transition focus:border-[#3b82f6] focus:ring-2 focus:ring-[#bfdbfe]"
                    />
                  </div>
                  <div>
            ...
            <div className="mt-9 flex items-center justify-end gap-4">
              <button
                type="button"
                onClick={resetDraft}
                className="px-4 py-2 text-base font-medium text-[#1e293b] transition hover:text-[#0f172a] cursor-pointer"
              >
                Reset
              </button>
              <button
                ...
                className="rounded-xl bg-[#2563eb] px-5 py-2.5 text-base font-semibold text-white shadow-[0_8px_20px_rgba(37,99,235,0.25)] transition hover:bg-[#1d4ed8] cursor-pointer"
              >
                Apply Filters
              </button>
            </div>
